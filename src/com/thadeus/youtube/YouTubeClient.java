...
public class YouTubeClient {
  ...
  public YouTubeClient() {
    ...
    requestFactory = transport.createRequestFactory(new HttpRequestInitializer() {
      ...
      public void initialize(HttpRequest request) {
        ...
        headers.setApplicationName("Witherberry");
  ...
  public YoutubeVideoFeed executeGetVideoFeed(YouTubeUrl url) throws IOException {
    return executeGetFeed(url, YoutubeVideoFeed.class);
  }
